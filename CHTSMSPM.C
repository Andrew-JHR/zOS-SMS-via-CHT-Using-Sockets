...
*    valid ones
* 4. One argrment argv[1] is expected and the first 10 bytes is cellphone number, and the remaining
*    bytes are for SMS message text.
* 5. Use CHTSMSJC.JCL to compile / Link the program
* 6. Use CHTSMSPM.JCL to run the program
*                                                 Andrew Jan 20200110
***************************************************************************************************/
...
strncpy(TelNum, argv[1], 10);
strncpy(Msg_Content, argv[1]+10, sizeof(argv[1])-11);
